...
class ToDoItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create to_do_item" do
    assert_difference('ToDoItem.count') do
      post to_do_items_url, params: { to_do_item: { User_id: @to_do_item.User_id, itemDescription: @to_do_item.itemDescription, priorityNumber: @to_do_item.priorityNumber } }
    end
  ...
  test "should update to_do_item" do
    patch to_do_item_url(@to_do_item), params: { to_do_item: { User_id: @to_do_item.User_id, itemDescription: @to_do_item.itemDescription, priorityNumber: @to_do_item.priorityNumber } }
